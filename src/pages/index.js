...
const main_logo = require('@/assets/main_logo.png')
// const image = require('@/assets/landing.svg')
...
export default function HeroBullets() {
  ...
  return (
    <div>
      ...
      <Header height={60} px="md">
        <Group position="apart" sx={{ height: '100%' }}>
          {/* <MantineLogo size={30} /> */}
          <NextImage src={main_logo} style={{height : "50px", width : "50px"}} />
    ...
    {/* ________________________---------______-----__----_-------------_-_-_-_-_-_--_-_-_---______-____-____-______-___- */}
      <Container>
        <div className={classes.inner}>
          <div className={classes.content}>
            <Title className={classes.title}>
              A <span className={classes.highlight}>modern</span> platform <br /> for practical coding
            </Title>
          ...
          {/* <Image src={image} className={classes.image} style={{width : "10px"}} /> */}
        </div>
      </Container>
    </div>
  );
